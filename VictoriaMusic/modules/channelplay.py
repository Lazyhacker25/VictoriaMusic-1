# Victoriamusic (Telegram bot project)
...
from VictoriaMusic.modules.play import generate_cover
from VictoriaMusic.modules.play import arq
from VictoriaMusic.modules.play import cb_admin_check
from VictoriaMusic.modules.play import transcode
from VictoriaMusic.modules.play import convert_seconds
from VictoriaMusic.modules.play import time_to_seconds
from VictoriaMusic.modules.play import changeImageSize
...
from VictoriaMusic.helpers.errors import DurationLimitError
from VictoriaMusic.helpers.decorators import errors
...
from VictoriaMusic.helpers.filters import command
from VictoriaMusic.helpers.filters import other_filters
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Victoriamusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
