...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "VictoriaXupdates")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "VictoriaSupport_Official")
PROJECT_NAME = getenv("PROJECT_NAME", "VictoriaMusic")
SOURCE_CODE = getenv("SOURCE_CODE", "https://github.com/TeamVictoriaX/VictoriaMusic")
