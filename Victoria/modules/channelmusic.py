...
from Victoria.modules.play import generate_cover
from Victoria.modules.play import arq
from Victoria.modules.play import cb_admin_check
from Victoria.modules.play import transcode
from Victoria.modules.play import convert_seconds
from Victoria.modules.play import time_to_seconds
from Victoria.modules.play import changeImageSize
from Victoria.config import BOT_NAME as bn
from Victoria.config import DURATION_LIMIT
from Victoria.config import UPDATES_CHANNEL as updateschannel
from Victoria.config import que
from Victoria.function.admins import admins as a
from Victoria.helpers.errors import DurationLimitError
from Victoria.helpers.decorators import errors
from Victoria.helpers.admins import get_administrators
from Victoria.helpers.channelmusic import get_chat_id
from Victoria.helpers.decorators import authorized_users_only
from Victoria.helpers.filters import command, other_filters
from Victoria.helpers.gets import get_file_name
from Victoria.services.callsmusic import callsmusic, queues
from Victoria.services.callsmusic.callsmusic import client as USER
from Victoria.services.converter.converter import convert
from Victoria.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Victoria to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
